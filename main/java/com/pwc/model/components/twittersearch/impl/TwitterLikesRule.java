...
public class TwitterLikesRule implements ITwitterTimelineRule {

    private String URL_BASE_FORMAT = "https://twitter.com/%s/likes";
    private String CSS_CLASS = "twitter-timeline";

    @Override
    public Boolean isMatch(TwitterModel model) {
        return model != null && model.widgetType.equals("likes");
    }
