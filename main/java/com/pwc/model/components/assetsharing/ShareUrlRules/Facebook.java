...
public class Facebook extends ShareRule {
    private static final String STRING_MATCH_RULE = "facebook";
    private static final String SHARE_URL_SUFIX = "/facebook.html";
